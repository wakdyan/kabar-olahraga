...
import 'package:kabar_olahraga/domain/repositories/footbal_repository.dart'
    as _i9;
import 'package:kabar_olahraga/domain/usecase/get_leagues.dart' as _i13;
...
/// A class which mocks [GetLeagues].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetLeagues extends _i1.Mock implements _i13.GetLeagues {
  MockGetLeagues() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<_i2.Either<_i10.Failure, List<_i12.League>>> execute() =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
